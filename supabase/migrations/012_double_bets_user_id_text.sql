-- ============================================================
-- MIGRAÇÃO 012: double_bets.user_id muda de UUID para TEXT
-- Permite user_id textual para bots (ex: 'bot-anasilva')
-- ============================================================

-- 1. Dropar FK constraint existente
ALTER TABLE public.double_bets DROP CONSTRAINT IF EXISTS double_bets_user_id_fkey;

-- 2. Mudar coluna de UUID para TEXT
ALTER TABLE public.double_bets ALTER COLUMN user_id TYPE TEXT;

-- 3. Atualizar place_bet RPC para comparar auth.uid() como TEXT
